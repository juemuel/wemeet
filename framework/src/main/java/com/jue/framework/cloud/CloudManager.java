package com.jue.framework.cloud;
...
public class CloudManager {
    ...
    //Key原：k51hidwqk4yeb 原s：os83U32SrAG
    //mk：k51hidwqkg4vb ms：x2oOYBJy0uW2
    public static final String CLOUD_KEY = "k51hidwqkg4vb";
    public static final String CLOUD_SECRET = "x2oOYBJy0uW2";

    //融云的消息类型
    // ObjectName
    public static final String MSG_TEXT_NAME = "RC:TxtMsg";//文字
    public static final String MSG_IMAGE_NAME = "RC:ImgMsg";//图片
    public static final String MSG_LOCATION_NAME = "RC:LBSMsg";//位置
