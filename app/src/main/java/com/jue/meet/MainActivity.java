...
import com.jue.meet.fragment.ChatFragment;
import com.jue.meet.fragment.MeFragment;
import com.jue.meet.fragment.SquareFragment;
import com.jue.meet.fragment.StarFragment;
import com.jue.meet.service.CloudService;
import com.jue.meet.ui.FirstUploadActivity;
import com.jue.framework.base.BaseUIActivity;
import com.jue.framework.bmob.BmobManager;
import com.jue.framework.entity.Constants;
import com.jue.framework.event.EventManager;
import com.jue.framework.event.MessageEvent;
import com.jue.framework.gson.TokenBean;
import com.jue.framework.helper.UpdateHelper;
import com.jue.framework.manager.DialogManager;
import com.jue.framework.manager.HttpManager;
...
public class MainActivity extends BaseUIActivity implements View.OnClickListener {
    ...
    /**
     * 初始化View，请求权限+获取view+显示默认标签+检查token
     */
...
//        SimulationData.testData();
    ...
    /**
     * 5.重写onAttachFragment方法
     * 当应用的内存紧张的时候，系统会回收掉Fragment对象
     * 再一次进入的时候会重新创建Fragment
     * 非原来对象，我们无法控制，导致重叠，我们要防止这样的事情
     *
     * @param fragment
     */
    @Override
    ...
    private void parsingCloudToken(String s) {
        try {
            ...
            if (tokenBean.getCode() == 200) {
                ...
                Toast.makeText(this, "哦嚯嚯，不好意思，注册人数已达服务器上限~", Toast.LENGTH_SHORT).show();
            }
        } catch (Exception e) {
