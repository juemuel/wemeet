...
import com.jue.meet.model.ChatModel;
...
import com.jue.framework.gson.TextBean;
import com.jue.framework.gson.VoiceBean;
import com.jue.framework.helper.FileHelper;
import com.jue.framework.manager.MapManager;
import com.jue.framework.manager.VoiceManager;
...
public class ChatActivity extends BaseBackActivity implements View.OnClickListener {
    ...
    //时间
    public static final int TYPE_CHAT_TIME = 6;
            ...
            public void onBindViewHolder(final ChatModel model, CommonViewHolder viewHolder, int type, int position) {
                switch (model.getType()) {
                    ...
                    case TYPE_RIGHT_LOCATION:
                        ...
                        break;
                    case TYPE_CHAT_TIME:
                        viewHolder.setText(R.id.tv_time, TimeUtils.formatTime(model.getMessageTime()));
                        break;
                }
            }
     ...
     * @param time
     */
    private void addTimeItem(long time) {
        ChatModel chatModel = new ChatModel();
        chatModel.setMessageTime(time);
        chatModel.setType(TYPE_CHAT_TIME);
        mList.add(chatModel);
    }
